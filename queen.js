...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("LAKSHAN-MD~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🚀 **© PRIME-LAKSHAN 𝗑ᴾᴿᴼ 💚 Connected Successfully!** ✅ 
          
          --- **🎉 Welcome to © PRIME_LAKSHAN 𝗑ᴾᴿᴼ 💚!** 🎉 
          ...
          --- Thank you for using **© PRIMR LAKSHAN 𝗑ᴾᴿᴼ 💚**. 
      ...
      conn.sendMessage(conn.user.id, {
        ...
        contextInfo: {
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: "© PRIME LAKSHAN 𝗑ᴾᴿᴼ 💚",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "© PRIME-LAKSHAN 𝗑ᴾᴿᴼ 💚",
            body: " ©𝐌𝐑 LAKSHAN 𝐎𝐅𝐂 💚",
            mediaType: 1,
...
if (!app) return;
app.get("/", (req, res) => {
  res.send("hey I am alive, PRIME_LAKSHAN Is started✅");
});
app.listen(port, () =>
